...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if(( self = [super initWithCoder:aDecoder] )) {
        ...
        items = [[NSMutableArray alloc] initWithObjects:@"Desert", @"Dinner", @"Breakfast", @"Lunch", nil];
...
- (UIView*)popItemForDragFrom:(CGPoint)point {
    ...
    UITableViewCell* cellCopy = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"DragDestinationCell"];
...
- (void)draggable:(UIView *)draggable enteredAtPoint:(CGPoint)point {
    ...
    [items insertObject:@" " atIndex:row];
...
- (void)draggable:(UIView*)draggable droppedAtPoint:(CGPoint)point {
    ...
    [items insertObject:[NSString stringWithFormat:@"%@", [draggedCell.textLabel.text lowercaseString]] atIndex:row];
